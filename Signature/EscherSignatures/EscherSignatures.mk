...
##
## Debug
ProjectName            :=EscherSignatures
ConfigurationName      :=Debug
WorkspacePath          :=/home/sshehata/Projects/CodeLite
ProjectPath            :=/home/sshehata/Projects/post-quant-crypto/Signature/EscherSignatures
...
ObjectsFileList        :="EscherSignatures.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/up_list.c$(ObjectSuffix) $(IntermediateDirectory)/up_main.c$(ObjectSuffix) $(IntermediateDirectory)/up_params.c$(ObjectSuffix) $(IntermediateDirectory)/up_print_utils.c$(ObjectSuffix) $(IntermediateDirectory)/up_util.c$(ObjectSuffix) $(IntermediateDirectory)/up_reference_s.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/up_list.c$(ObjectSuffix): ../list.c $(IntermediateDirectory)/up_list.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/list.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_list.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_main.c$(ObjectSuffix): ../main.c $(IntermediateDirectory)/up_main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_params.c$(ObjectSuffix): ../params.c $(IntermediateDirectory)/up_params.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/params.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_params.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_print_utils.c$(ObjectSuffix): ../print_utils.c $(IntermediateDirectory)/up_print_utils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/print_utils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_print_utils.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_util.c$(ObjectSuffix): ../util.c $(IntermediateDirectory)/up_util.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/util.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_util.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_reference_s.c$(ObjectSuffix): ../reference_s.c $(IntermediateDirectory)/up_reference_s.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/sshehata/Projects/post-quant-crypto/Signature/reference_s.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_reference_s.c$(ObjectSuffix) $(IncludePath)
